            ...
            return (
              <div
                ...
                className={`rounded-2xl border transition-all duration-300 backdrop-blur-md overflow-hidden ${
                  isOpen
                    ? "bg-slate-900/40 border-slate-800/80 shadow-[0_15px_30px_rgba(0,0,0,0.3)]"
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4 pr-4">
                    <HelpCircle
                      size={16}
                      className={`shrink-0 transition-colors duration-300 ${isOpen ? "text-blue-400" : "text-slate-400 group-hover:text-slate-500"}`}
                    />
                    <h3 className="font-semibold text-base md:text-lg text-slate-200 group-hover:text-white transition-colors">
                      {faq.question}
                    </h3>
                  </div>

                  <div
                    className={`h-8 w-8 rounded-full flex items-center justify-center border transition-all duration-300 shrink-0 ${isOpen ? "bg-blue-600 border-blue-500 text-white rotate-180" : "bg-slate-950 border-slate-800 text-slate-500"}`}
                  >
                    <ChevronDown
                      size={14}
                ...
                >
                  <div className="overflow-hidden">
                    <div className="px-6 pb-6 pl-14 text-xs md:text-sm text-slate-400 leading-relaxed border-t border-slate-900/40 pt-4 mt-1">
                      {faq.answer}
                    </div>
                  </div>
                </div>

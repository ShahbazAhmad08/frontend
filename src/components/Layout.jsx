...
export default function PremiumLayout({ children }) {
  const whatsappUrl =
    "https://wa.me/919449617399?text=I%20have%20a%20query%20regarding%20your%20services";
  return (
    <div className="flex flex-col min-h-screen bg-white font-sans selection:bg-blue-500/20 selection:text-blue-400 antialiased">
      ...
      <a
        ...
        className="fixed md:bottom-6 md:right-6 bottom-12 right-6 z-50 h-14 w-14 rounded-full bg-[#25D366] hover:bg-[#20ba5a] text-white flex items-center justify-center   hover:-translate-y-1 transition-all duration-300 group"
      >
        {/* High-Fidelity Font Awesome / Pure SVG Vector Path for official WhatsApp branding */}
        <svg
          viewBox="0 0 448 512"
          fill="currentColor"
